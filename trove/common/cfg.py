...
common_opts = [
    ...
    cfg.ListOpt('master_user_grant', default=[],
                help="Permissions to grant to the 'master' user."),
    cfg.BoolOpt('master_user_grant_option', default=True,
                help="Assign the 'master' user GRANT permissions."),
